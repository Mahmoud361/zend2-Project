...
class __Mustache_f88035871d453bc58d6f7aab067de7b7 extends Mustache_Template
{
...
';
        ...
        $buffer .= $this->section6b97e8d5f16ae9f6d4c09d660bc58539($context, $indent, $value);
        $buffer .= $indent . '
';
        $buffer .= $indent . '</body>
';
...
';
    ...
    private function section6b97e8d5f16ae9f6d4c09d660bc58539(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
    
        if (!is_string($value) && is_callable($value)) {
            $source = '
<strong>{{students->address}}m<br></strong>
';

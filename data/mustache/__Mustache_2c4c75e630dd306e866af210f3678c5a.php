...
class __Mustache_2c4c75e630dd306e866af210f3678c5a extends Mustache_Template
{
...
';
        ...
        $buffer .= $this->section76c6aa64d61f8fe9876cd8765fcd35e1($context, $indent, $value);
        $buffer .= $indent . '
';
        $buffer .= $indent . '</body>
';
...
';
    ...
    private function section76c6aa64d61f8fe9876cd8765fcd35e1(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
    
        if (!is_string($value) && is_callable($value)) {
            $source = '
<strong>{{student->address}}m</strong>
';
            ...
            foreach ($values as $value) {
                ...
                $value = $this->resolveValue($context->find('student->address'), $context);
                $buffer .= htmlspecialchars($value, 2, 'UTF-8');
                $buffer .= 'm</strong>
';
                $context->pop();

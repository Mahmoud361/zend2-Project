...
class __Mustache_6daa8ee13c37b15ae68d2c94c40bdf86 extends Mustache_Template
{
...
';
        ...
        $buffer .= $this->sectionCfddddb22e817fef0aa05a19860fa0b6($context, $indent, $value);
        $buffer .= $indent . '
';
        $buffer .= $indent . '</body>
';
...
';
    ...
    private function sectionCfddddb22e817fef0aa05a19860fa0b6(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
    
        if (!is_string($value) && is_callable($value)) {
            $source = '
<strong>{{id}}m<<br>/strong>
';

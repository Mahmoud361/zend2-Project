...
class __Mustache_9f151b531fc531a6e21424d738bfb450 extends Mustache_Template
{
...
';
        ...
        $buffer .= $this->section03d7874d5e4abc259ab985f6e623a193($context, $indent, $value);
        $buffer .= $indent . '
';
        $buffer .= $indent . '</body>
';
...
';
    ...
    private function section03d7874d5e4abc259ab985f6e623a193(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
    
        if (!is_string($value) && is_callable($value)) {
            $source = '
<strong>  {{fristName}} m <br></strong>
';
            ...
            foreach ($values as $value) {
                ...
                $value = $this->resolveValue($context->find('fristName'), $context);
                $buffer .= htmlspecialchars($value, 2, 'UTF-8');
                $buffer .= ' m <br></strong>
';
                $context->pop();

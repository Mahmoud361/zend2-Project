...
class __Mustache_e26ce060bad8bdfada5a64a4a7a8426b extends Mustache_Template
{
...
';
        ...
        $buffer .= $this->section41e086fef9845b79598a4e7a6b39cded($context, $indent, $value);
        $buffer .= $indent . '
';
        $buffer .= $indent . '</body>
';
...
';
    ...
    private function section41e086fef9845b79598a4e7a6b39cded(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
    
        if (!is_string($value) && is_callable($value)) {
            $source = '
<strong>  {{"testParams"}} m <br></strong>
';
            ...
            foreach ($values as $value) {
                ...
                $value = $this->resolveValue($context->find('"testParams"'), $context);
                $buffer .= htmlspecialchars($value, 2, 'UTF-8');
                $buffer .= ' m <br></strong>
';
                $context->pop();

...
class __Mustache_7bdade3783e73a462009edae258817eb extends Mustache_Template
{
...
';
        ...
        $buffer .= $this->section39390be1ae838eca25ac4c5ab1cc9676($context, $indent, $value);
        $buffer .= $indent . '
';
        $buffer .= $indent . '</body>
';
...
';
    ...
    private function section39390be1ae838eca25ac4c5ab1cc9676(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
    
        if (!is_string($value) && is_callable($value)) {
            $source = '
<strong>{{fristName}}m</strong>
';

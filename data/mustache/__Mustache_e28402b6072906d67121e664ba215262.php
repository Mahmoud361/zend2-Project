...
class __Mustache_e28402b6072906d67121e664ba215262 extends Mustache_Template
{
...
';
        ...
        $buffer .= $this->sectionFbf362febfea179cdff77e7c3c0b5377($context, $indent, $value);
        $buffer .= $indent . '
';
        $buffer .= $indent . '</body>
';
...
';
    ...
    private function sectionFbf362febfea179cdff77e7c3c0b5377(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
    
        if (!is_string($value) && is_callable($value)) {
            $source = '
<strong>{{student->id}}m</strong>
';
            ...
            foreach ($values as $value) {
                ...
                $value = $this->resolveValue($context->find('student->id'), $context);
                $buffer .= htmlspecialchars($value, 2, 'UTF-8');
                $buffer .= 'm</strong>
';
                $context->pop();

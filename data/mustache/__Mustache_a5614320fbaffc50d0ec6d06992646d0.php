...
class __Mustache_a5614320fbaffc50d0ec6d06992646d0 extends Mustache_Template
{
...
';
        $buffer .= $indent . '
';
        $buffer .= $indent . '<h1><?php  $this->escapeHtml($title);  ?></h1>
';
        $buffer .= $indent . '
';
        $buffer .= $indent . '<p>
...
';
        $buffer .= $indent . '                    <a href="<?php echo $this->url(\'news\',
';
        $buffer .= $indent . '                        array(
';
...
';
        $buffer .= $indent . '                            \'studentid\' =>$student->id
';

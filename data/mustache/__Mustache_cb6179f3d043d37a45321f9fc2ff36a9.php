...
class __Mustache_cb6179f3d043d37a45321f9fc2ff36a9 extends Mustache_Template
{
...
';
        ...
        $buffer .= $this->section85c44054cffc0fdb72509c148cb9baf9($context, $indent, $value);
        $buffer .= $indent . '
';
        $buffer .= $indent . '</body>
';
...
';
    ...
    private function section85c44054cffc0fdb72509c148cb9baf9(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
    
        if (!is_string($value) && is_callable($value)) {
            $source = '
<strong>  {{students}} m <br></strong>
';

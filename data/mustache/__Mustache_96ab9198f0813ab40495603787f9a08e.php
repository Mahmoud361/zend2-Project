...
class __Mustache_96ab9198f0813ab40495603787f9a08e extends Mustache_Template
{
...
';
        ...
        $buffer .= $this->section011b2d32eb303d0c502dcb6f645fc741($context, $indent, $value);
        $buffer .= $indent . '
';
        $buffer .= $indent . '</body>
';
...
';
    ...
    private function section011b2d32eb303d0c502dcb6f645fc741(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
    
        if (!is_string($value) && is_callable($value)) {
            $source = '
<strong>  {{student}} m <br></strong>
';
            ...
            foreach ($values as $value) {
                ...
                $value = $this->resolveValue($context->find('student'), $context);
                $buffer .= htmlspecialchars($value, 2, 'UTF-8');
                $buffer .= ' m <br></strong>
';
                $context->pop();

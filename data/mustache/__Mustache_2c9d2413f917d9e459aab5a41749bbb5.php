...
class __Mustache_2c9d2413f917d9e459aab5a41749bbb5 extends Mustache_Template
{
...
';
        ...
        $buffer .= $this->sectionF6bf34f1c7d7dbd877c73ddb4b347b66($context, $indent, $value);
        $buffer .= $indent . '
';
        $buffer .= $indent . '</body>
';
...
';
    ...
    private function sectionF6bf34f1c7d7dbd877c73ddb4b347b66(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
    
        if (!is_string($value) && is_callable($value)) {
            $source = '
<strong>  {{students[1]}} m <br></strong>
';
            ...
            foreach ($values as $value) {
                ...
                $value = $this->resolveValue($context->find('students[1]'), $context);
                $buffer .= htmlspecialchars($value, 2, 'UTF-8');
                $buffer .= ' m <br></strong>
';
                $context->pop();

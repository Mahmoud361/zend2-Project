...
class __Mustache_96c3979b1507fc45bdbf6a508d7fc312 extends Mustache_Template
{
...
';
        ...
        $buffer .= $this->sectionBc6798f3305ae285081f002e2b3ac5d3($context, $indent, $value);
        $buffer .= $indent . '
';
        $buffer .= $indent . '</body>
';
...
';
    ...
    private function sectionBc6798f3305ae285081f002e2b3ac5d3(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
    
        if (!is_string($value) && is_callable($value)) {
            $source = '
<strong>{{students[0}}m<br></strong>
';
            ...
            foreach ($values as $value) {
                ...
                $value = $this->resolveValue($context->find('students[0'), $context);
                $buffer .= htmlspecialchars($value, 2, 'UTF-8');
                $buffer .= 'm<br></strong>
';
                $context->pop();

...
class __Mustache_6db07564004da3036a4209179c24ac4b extends Mustache_Template
{
...
';
        ...
        $buffer .= $this->section2e3a4e42a8fd6ec7795ef2af7ce8ba30($context, $indent, $value);
        $buffer .= $indent . '
';
        $buffer .= $indent . '</body>
';
...
';
    ...
    private function section2e3a4e42a8fd6ec7795ef2af7ce8ba30(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
    
        if (!is_string($value) && is_callable($value)) {
            $source = '
<strong>{{student.fristName}}m<br></strong>
';
            ...
            foreach ($values as $value) {
                ...
                $value = $this->resolveValue($context->findDot('student.fristName'), $context);
                $buffer .= htmlspecialchars($value, 2, 'UTF-8');
                $buffer .= 'm<br></strong>
';
                $context->pop();
